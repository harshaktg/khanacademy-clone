            ...
            <div class="flex h-full items-center text-base">
                <div class="hidden md:flex lg:gap-x-0 h-full items-center gap-x-4 justify-start flex-grow basis-0 pl-5">
                    <div class="inline-block h-full whitespace-nowrap">
                        <button aria-expanded="false" data-testid="learn-menu-dropdown" type="button"
                            aria-disabled="false"
                            class="flex whitespace-nowrap p-0 h-full font-bold items-center bg-transparent border-none text-base text-primary"><span
                                data-learn-menu-trigger="true" class="block font-bold leading-5"
                                data-testid="learn-menu-button">Explore<span class="ml-1.5 relative"><span
                                        class="caret-logo icon"></span></span></span></button>
                    </div>
                    <div class="flex flex-col items-stretch py-3 mx-8 w-[200px] relative">
                        <button type="button" data-testid="navbar-search-button" role="button"
                            ...
                            class="inline-flex items-center justify-start flex-grow h-10 px-4 rounded bg-transparent border border-solid border-[#909296] text-primary hover:outline hover:outline-2 hover:-outline-offset-2 hover:outline-primary">
                            <div class="flex flex-col p-0.5 min-h-0 items-stretch"><span aria-hidden="true"
                                    data-testid="navbar-search-button-start-icon" class="search-logo icon"></span></div>
                ...
                <div class="pr-0 md:pr-5 gap-x-4 lg:gap-x-8 flex h-full flex-grow basis-0 justify-end items-center">
                    ...
                    <a role="button" rel="nofollow"
                        ...
                        href="/signup"><span
                            ...
                            up</span></a>
                    <div class="flex md:hidden items-stretch"><a data-testid="mobile-search-button"
                            aria-disabled="false" class="overflow-visible bg-transparent mr-4" href="/search"><span
                                ...
                                class="inline-block align-text-bottom w-6 h-6 bg-primary search-icon icon"></span></a>
                    </div>
                    <div class="flex md:hidden items-stretch"><button aria-expanded="false" aria-label="Open menu"
                            aria-controls="page-header-responsive-nav-menu" data-testid="mobile-header-menu-button"
                            type="button" aria-disabled="false"
                            class="flex items-center text-primary font-bold h-full bg-transparent border-none overflow-visible mr-4"><span
                                class="inline-block align-text-bottom w-6 h-6 bg-primary hamburger-icon icon"></span></button>
                    </div>
